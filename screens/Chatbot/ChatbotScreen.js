...
// import { process.env.EXPO_PUBLIC_GEMINI_API_KEY } from "@env";
...
const ChatbotScreen = () => {
  ...
  const [loading, setLoading] = useState(null); // verificação de se está carregando ou não
  const [sending, setSending] = useState(null); // bloqueio de acordo com se já tem um texto enviando ou não
    ...
    const chatSession = model.startChat({
      ...
      history: [
        ...
        },
        {
          role: "user",
          parts: [
            { text: "luna voce se lembra dos links?\n" },
          ],
        },
        {
          role: "model",
        ...
        },
        {
          role: "user",
          parts: [
            { text: "otimo luna, vou te mandar o link do site" },
          ],
        },
        {
          role: "model",
        ...
        },
        {
          role: "user",
          parts: [
            { text: "agora sim iniciaremos a simulação" },
          ],
        },
        {
          role: "model",
        ...
        },
        {
          role: "user",
          parts: [
            { text: "oi gostaria de saber mais sobre o sesi-cat" },
          ],
        },
        {
          role: "model",
        ...
        },
        {
          role: "user",
          parts: [
            { text: "quais horarios o sesi esta aberto?" },
          ],
        },
        {
          role: "model",
          parts: [
            { text: "Os horários de funcionamento do SESI-CAT podem variar um pouco dependendo da unidade. 🤔\n\nPara ter certeza dos horários da unidade que te interessa, recomendo que você acesse o site  https://www.sesisp.org.br/esporte/  Lá você encontra os horários de cada unidade SESI-CAT. 😊\n\nSe preferir, me diga qual unidade você gostaria de frequentar que eu posso tentar encontrar o horário para você. 😉\n" },
          ],
        },
        {
          role: "user",
        ...
        },
        {
          role: "user",
          parts: [
            { text: "por enquanto nao, vamos iniciar uma simulação" },
          ],
        },
        {
          role: "model",
        ...
        },
        {
          role: "user",
          parts: [
            { text: "gostaria de saber mais sobre o sesi cat\n" },
          ],
        },
        {
          role: "model",
  ...
  const finalizarChat = ({navigation}) => {
    setInputHistory([]);

    navigation.navigate("Avalicao_tela");
  };
  ...
  return (
    <View style={styles.container}>
          ...
          <View key={index}>
            <View style={[styles.messageContainer, styles.usermessage]}>
              <View style={styles.userMessage}>
                <Text style={styles.userText}>{typeof history.userInput === 'string' ? history.userInput : JSON.stringify(history.userInput)}</Text>
              </View>
              <Image
                source={user ? { uri: user.photoURL } : require('../../assets/navbar/profile.png')}
            ...
            <View key={index} style={styles.messageContainer}>
              ...
              <View style={styles.botMessage}>
                ...
                >{formatBoldText(history.botResponse)}</Text>
              </View>
            </View>
          </View>
        ))}
      ...
      <View style={styles.inputContainer}>
        ...
        />
        <TouchableOpacity disabled={sending} style={styles.sendButton} onPress={run}>
